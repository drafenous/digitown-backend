...
const UserEnterpriseData_1 = __importDefault(require("../data/UserEnterpriseData"));
class UserEnterpriseService {
    constructor() {
        this.db = new UserEnterpriseData_1.default();
    }
    login(req, res) {
...
exports.default = UserEnterpriseService;
